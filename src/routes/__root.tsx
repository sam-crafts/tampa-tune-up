...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Canvas Landscapes" },
      { property: "og:site_name", content: "Canvas Landscapes" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Canvas Landscapes",
          image: "/og-image.jpg",
          telephone: "+18135550192",
          email: "hello@canvaslandscapes.com",
          priceRange: "$$",
          address: { "@type": "PostalAddress", addressLocality: "Tampa", addressRegion: "FL", addressCountry: "US" },
          areaServed: ["Tampa", "St. Petersburg", "Clearwater", "Brandon", "Riverview", "Lutz", "Wesley Chapel", "Land O' Lakes", "Temple Terrace", "Plant City"],
          aggregateRating: { "@type": "AggregateRating", ratingValue: "4.9", reviewCount: "220" },
        }),
      },
    ],
  }),
