  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-prose relative z-10 grid min-h-[640px] place-items-center py-24 text-center text-primary-foreground md:min-h-[760px] md:py-32">
          <div className="max-w-3xl">
            <Reveal variant="blur-up" duration={800}>
            ...
            <Reveal variant="blur-up" delay={150} duration={900}>
            ...
            <Reveal variant="fade-up" delay={350} duration={800}>
            ...
            <Reveal variant="fade" delay={700} duration={900}>
        ...
        <div className="container-prose">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              <Reveal key={step} variant="fade-up" delay={i * 140}>
                <div className="rounded-2xl border border-border bg-card p-8 transition hover:-translate-y-1 hover:shadow-md">
      ...
      <section className="container-prose grid gap-10 py-20 md:grid-cols-2 md:py-28">
        ...
        <Reveal variant="slide-right" duration={900} delay={120}>
      ...
      <section className="bg-secondary/50 py-20 md:py-28">
        <div className="container-prose">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {portfolio.map((p, i) => (
              <Reveal key={p.tag} variant="zoom-in" delay={(i % 3) * 100} duration={750}>
      ...
      <section className="container-prose py-20 md:py-28">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {reviews.map((r, i) => (
            <Reveal key={r.name} variant="fade-up" delay={i * 130}>
